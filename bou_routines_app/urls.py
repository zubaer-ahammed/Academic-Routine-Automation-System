...
urlpatterns = [
    ...
    path('marks/export-midterm-pdf/', views.export_midterm_marks_pdf, name='export-midterm-marks-pdf'),
    path('marks/export-blank-midterm-pdf/', views.export_blank_midterm_marks_pdf, name='export-blank-midterm-marks-pdf'),
    path('marks/export-midterm-excel/', views.export_midterm_marks_excel, name='export-midterm-marks-excel'),
